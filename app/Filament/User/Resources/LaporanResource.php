...
use App\Filament\User\Resources\LaporanResource\Pages;
use App\Filament\User\Resources\LaporanResource\RelationManagers;
...
class LaporanResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ImageColumn::make('gambar_laporan')
                    ->disk('public')
                    ->label('Gambar Laporan')
                    ->url(fn ($record) => 'http://127.0.0.1:8000/storage/' . $record->gambar_laporan)
                    ->circular(),
                TextColumn::make('id')
                    ->label('Nomor Laporan'),
    ...
    public static function getPages(): array
    {
        return [
            ...
            'edit' => Pages\EditLaporan::route('user/{record}/edit'),
